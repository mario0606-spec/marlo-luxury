...
-- CreateEnum
CREATE TYPE "ItemCategory" AS ENUM ('WATCH', 'JEWELRY', 'BAG', 'ACCESSORY', 'OTHER');

-- CreateEnum
CREATE TYPE "RentalStatus" AS ENUM ('PENDING', 'CONFIRMED', 'ACTIVE', 'RETURNED', 'CANCELLED', 'OVERDUE');
...
-- CreateIndex
CREATE INDEX "Item_available_idx" ON "Item"("available");
